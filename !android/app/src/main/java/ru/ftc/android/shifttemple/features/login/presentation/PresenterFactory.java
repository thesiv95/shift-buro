...
import ru.ftc.android.shifttemple.features.login.data.user.UserApi;
import ru.ftc.android.shifttemple.features.login.data.user.UserDataSource;
import ru.ftc.android.shifttemple.features.login.data.user.UserDataSourceImpl;
import ru.ftc.android.shifttemple.features.login.data.user.UserRepository;
import ru.ftc.android.shifttemple.features.login.data.user.UserRepositoryImpl;
